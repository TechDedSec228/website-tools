...
<table border="0" align="center" cellpadding="4" cellspacing="0" class="srch_tbl">
  ...
  <tr>
    ...
    <td valign="top"><textarea class="ui-widget-content" name="keywords" id="keywords" cols="30" rows="6"><?PHP if($_SESSION['keywords'] != '') echo $_SESSION['keywords']; else echo 'blue thursday monkey
norfolk insurance
