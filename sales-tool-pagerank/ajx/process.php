...
if(!empty($_POST['process_later'])) {
  proc_rep_later('sales-tool-pagerank');
} else {
  include_once(SERV_ROOT.'classes/simple_html_dom.php');
  include_once(SERV_ROOT.'classes/fetch_html.php');
  $data_grab = new data_grab;
  $data_grab->link_checking = 1;
  include_once(SERV_ROOT.'sales-tool-pagerank/classes/scrapper_goog.php');
  ...
  include_once(SERV_ROOT.'sales-tool-pagerank/classes/process_rep.php');
