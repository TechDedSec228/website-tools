  ...
  function proc_rpt() {
	...
	foreach($this->search_terms as $cur_srch_val) {
	  ...
	  ob_start();
		  ...
		  // load template
		  require(SERV_ROOT.'sales-tool-allintitle/def.css');
	  ...
	  $report_type = 'sales-tool-allintitle';
	  ...
	  if(!empty($_POST['email_address'])) {
		...
		$email_data['subject'] = 'CM Sales allintitle only Search Tool Results '.date("m-d-Y");
